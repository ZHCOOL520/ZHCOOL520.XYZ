...
export default function Footer() {
  ...
  return (
    <footer className="relative py-7 px-6 z-10 border-t border-neutral-200/50 dark:border-white/5 liquid-glass-light">
      <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 text-sm">
        ...
        <div className="flex items-center gap-4">
          {pathname !== '/' && <Link to="/" className="btn-glass text-[11px] py-1.5 px-3 font-medium">主站</Link>}
